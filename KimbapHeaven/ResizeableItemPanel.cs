...
{
    //stack overflow: https://stackoverflow.com/a/41603366
    class ResizeableItemPanel : Panel
    {
        ...
        public static readonly DependencyProperty ItemMinWidthProperty = DependencyProperty.Register("ItemMinWidth", typeof(double), typeof(ResizeableItemPanel), new PropertyMetadata(200D)); //default min: 200
        ...
        public static readonly DependencyProperty MaxColumnCountProperty = DependencyProperty.Register("MaxColumnCount", typeof(int), typeof(ResizeableItemPanel), new PropertyMetadata(10)); //default max col: 10
